  ...
  return (
    <>
      ...
      <aside className={`app-sidebar ${isOpen ? 'sidebar-open' : ''}`} style={{
        ...
        {/* Nav */}
        <nav style={{ flex: 1, padding: '14px 10px', display: 'flex', flexDirection: 'column', gap: '1px', overflowY: 'auto' }}>
  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh' }}>
      ...
      <div className="mobile-topbar">
        ...
        <span style={{
          fontFamily: 'Inter, sans-serif', fontWeight: 800, fontSize: '14px', color: '#F1F5F9',
        }}>CIMS</span>
